...
// ✅ Navbar imported — same pattern as registry/page.tsx
// ✅ page-root + Navbar + page-content pattern (exact registry logic)
// ✅ Header + footer collapse FIXED
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /*
          ══════════════════════════════════════════════════════
          REGISTRY PATTERN — exact same as registry/page.tsx:

            .page-root   → min-height:100vh, display:flex, flex-direction:column
            <Navbar />   → sits as first child (flex-shrink:0 from its own styles)
            .page-content → flex:1  (grows to fill remaining space)

          This is what prevents header/footer collapse.
          ══════════════════════════════════════════════════════
        */
        .blog-page-root {
          min-height: 100vh;
        ...
        /* ── HERO — NO overflow:hidden so search dropdown can escape ── */
        .blog-hero {
          position: relative;
        ...
        /* ── SEARCH — z-index:9999 so dropdown is above all cards/sections ── */
        .search-wrap {
        ...
        .main-wrap { max-width: 1340px; margin: 0 auto; padding: 28px clamp(16px, 4vw, 48px) 56px; }
      ...
      {/* ══ REGISTRY PATTERN ══
          .blog-page-root  →  flex column, min-height:100vh
          <Navbar />       →  header (never collapses)
          .blog-page-content → flex:1 (fills all space between navbar and bottom)
      */}
