        ...
        <main style={{ maxWidth:1300, margin:"0 auto", padding:"clamp(28px,4vw,52px) clamp(16px,4vw,48px) 60px" }}>
          ...
          <section className="au3" style={{ marginTop:40 }}>
            <div style={{ background:"#1A1208", padding:"clamp(28px,4vw,48px) clamp(20px,4vw,48px)", display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:24 }}>
              ...
              <Link
                href="/submit"
                style={{ flexShrink:0, display:"inline-flex", alignItems:"center", gap:8, background:"white", color:"#1A1208", padding:"12px 28px", fontSize:10, fontWeight:900, textTransform:"uppercase", letterSpacing:"0.18em", fontFamily:"system-ui,sans-serif", textDecoration:"none", transition:"background .15s" }}
                onMouseOver={(e) => (e.currentTarget.style.background = "#E8C547")}
